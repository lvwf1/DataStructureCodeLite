...
int main( )
{
    ...
    cout<<"Now I insert 15 that already exist in set3, nothing should happen"<<endl;
    cout<<"The elements of s3: ";
    s3.display();
    ...
    cout<<"Now I remove 1 from set3, nothing should happen"<<endl;
    cout<<"The elements of set3: ";
    s3.display();
    s3.remove(11);//Test remove existed values
    cout<<"Now I remove 11 from set3, 11 should be removed"<<endl;
    cout<<"The elements of set3: ";
    s3.display();
